...
/*   Updated: 2023/03/10 16:41:40 by wportilh         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	gradesConstructorTests(void)
{
	...
	try
	{
		...
		AForm	real_madrid("Real Madrid", 0, 1);
	...
	try
	{
		...
		AForm	real_madrid("Real Madrid", 1, 0);
		Bureaucrat cristiano(1, "Cristiano");
	}
	catch(std::exception & e)
	{
	...
	try
	{
		...
		AForm	real_madrid("Real Madrid", 151, 1);
		Bureaucrat cristiano(1, "Cristiano");
	}
	catch(std::exception & e)
	{
	...
	try
	{
		...
		AForm	real_madrid("Real Madrid", 1, 151);
		Bureaucrat cristiano(1, "Cristiano");
	}
	catch(std::exception & e)
	{
	...
	try
	{
		...
		AForm	real_madrid("Real Madrid", 1, 150);
		Bureaucrat cristiano(1, "Cristiano");
	}
	catch(std::exception & e)
	{
	...
	{
		std::cout << "grade_to_sign and grade_to_execute ok:" << std::endl;
		AForm	real_madrid("Real Madrid", 150, 1);
		Bureaucrat cristiano(1, "Cristiano");
	}
	catch(std::exception & e)
	{
...
static void	gettersTests(void)
{
	...
	try
	{
		AForm	real_madrid("Real Madrid", 1, 1);
		std::cout << std::endl;
...
static void	copyTests(void)
{
	...
	try
	{
		AForm	palmeiras("Palmeiras", 1, 1);
		AForm	palestra_italia(palmeiras);
		std::cout << palmeiras;
...
static void	assignmentTests(void)
{
	...
	try
	{
		AForm	paris_saint_germain("Paris Saint Germain", 20, 16);
		AForm	psg = paris_saint_germain;
	...
	try
	{
		AForm	selecao_braileira("Seleção Braileira", 5, 5);
		AForm	brasil = selecao_braileira;
