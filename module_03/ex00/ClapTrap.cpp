...
/*   Updated: 2023/02/25 21:38:08 by wportilh         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(void):	_name("🧗 Eldian"),
							...
							_attack_damage(0)
{
	std::cout << "default (" << this->get_name() << ") constructor called"
	<< std::endl;
	return ;
}
...
ClapTrap::ClapTrap(std::string const name):	_name(name),
											...
											_attack_damage(0)
{
	std::cout << "named constructor (" << this->get_name() << ") called"
	<< std::endl;
	return ;
}
...
{
	*this = ClapTrap;
	std::cout << "copy (" << this->get_name() << ") constructor called"
	<< std::endl;
	return ;
}
...
{
	std::cout << "destructor (" << this->get_name() << ") called"
	<< std::endl;
	return ;
}
...
ClapTrap	&ClapTrap::operator=(ClapTrap const &clap_trap)
{
	...
	std::cout << "assignment copy (" << this->get_name() << ") called"
	<< std::endl;
	return (*this);
}
